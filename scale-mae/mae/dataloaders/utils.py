...
def get_dataset_and_sampler(
    ...
    elif dataset_type in ["fmow", "2m"]:
        dataset = datasets.ImageFolder(
            root=config["data"]["img_dir"],
            transform=transforms_init,
            is_valid_file=is_fmow_rgb if dataset_type=="fmow" else lambda x: True,
        )
    ...
    if eval_dataset_id in [
        ...
        transform_eval = transforms.Compose(
                [
                    ...
                    transforms.Resize(256),  # downsample short side to 512
