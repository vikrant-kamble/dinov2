...
from dinov2.eval.setup import get_args_parser as get_setup_args_parser, setup_and_build_efficientnet_model
...
def main(args):
    model, autocast_dtype = setup_and_build_efficientnet_model(args)
    eval_knn_with_model(
        model=model,
